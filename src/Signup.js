        ...
        <div className="container-fluid content2 backimg1">
          <div className="container contentsign">
            <form>
              ...
              />
              <br />
              <p className="title1 pt-2">
                Gender:-
                <input type="radio" className="gendername" value={"Male"} />
                Male
                <input type="radio" className="gendername" value={"Female"} />
                Female
              </p>
              <br />
              <Link to={"/login"}>
                <button className="btn submit buttonfamaily">Submit</button>
              </Link>
              <Link to="/">
                <button className="btn btn-dark m-2 buttonfamaily">Back</button>
              </Link>
            </form>
          </div>
        </div>
